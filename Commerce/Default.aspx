<%@ Page Language="C#" Inherits="Commerce.Default" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Label runat="server" id ="LabelUsername" value = "Username can't be empty" />
          ...
          <asp:TextBox id="username" MaxLength = "20" runat="server" type = "text" placeholder = "Username"/>

        <asp:required TextBox id="FirstName" MaxLength = "20" runat="server" type = "text" placeholder = "FirstName"  />
        ...
        <asp:TextBox id="Email" MaxLength = "50" runat="server" type ="Email" placeholder = "Email"/>
